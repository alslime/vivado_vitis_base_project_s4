...
HD_PWD='C:/Travail/s4InfoAtelier4/s4InfoAtelier4.runs/atelier4_PPU_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log atelier4_PPU_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source atelier4_PPU_0_0.tcl
