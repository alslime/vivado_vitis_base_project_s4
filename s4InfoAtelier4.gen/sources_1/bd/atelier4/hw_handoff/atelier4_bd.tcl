...
################################################################
# This is a generated script based on design: atelier4
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: API_0, and set properties
  set API_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:API:1.0 API_0 ]

  # Create instance: PPU_0, and set properties
  set block_name PPU
  set block_cell_name PPU_0
  if { [catch {set PPU_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  set_property -dict [ list \
   CONFIG.C_VID_HEIGHT {360} \
   CONFIG.C_VID_WIDTH {640} \
 ] $pixelDataToVideoStre_0
  ...
  # Create instance: send_to_HDMI_0, and set properties
  set block_name send_to_HDMI
  set block_cell_name send_to_HDMI_0
  if { [catch {set send_to_HDMI_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $send_to_HDMI_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_intf_net -intf_net axi_vdma_0_M_AXI_S2MM [get_bd_intf_pins axi_vdma_0/M_AXI_S2MM] [get_bd_intf_pins smartconnect_1/S01_AXI]
  connect_bd_intf_net -intf_net pixelDataToVideoStre_0_M00_AXIS [get_bd_intf_pins axi_vdma_0/S_AXIS_S2MM] [get_bd_intf_pins pixelDataToVideoStre_0/M00_AXIS]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M03_AXI [get_bd_intf_pins API_0/S00_AXI] [get_bd_intf_pins smartconnect_0/M03_AXI]
  ...
  connect_bd_net -net API_0_o_reg0 [get_bd_pins API_0/o_reg0] [get_bd_pins PPU_0/i_reg0]
  connect_bd_net -net API_0_o_reg1 [get_bd_pins API_0/o_reg1] [get_bd_pins PPU_0/i_reg1]
  connect_bd_net -net API_0_o_reg2 [get_bd_pins API_0/o_reg2] [get_bd_pins PPU_0/i_reg2]
  connect_bd_net -net API_0_o_reg3 [get_bd_pins API_0/o_reg3] [get_bd_pins PPU_0/i_reg3]
  ...
  connect_bd_net -net PPU_0_o_color_code_24bits [get_bd_pins PPU_0/o_color_code_24bits] [get_bd_pins send_to_HDMI_0/i_color_code_24bits_of_pixel_to_send]
  connect_bd_net -net clk_in1_0_1 [get_bd_ports sys_clk] [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins API_0/s00_axi_aclk] [get_bd_pins PPU_0/clk] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins pixelDataToVideoStre_0/s00_axi_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins rgb2dvi_0/PixelClk] [get_bd_pins send_to_HDMI_0/clk] [get_bd_pins smartconnect_0/aclk1] [get_bd_pins smartconnect_1/aclk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins v_proc_ss_0/aclk_axis] [get_bd_pins v_proc_ss_0/aclk_ctrl] [get_bd_pins v_tc_0/clk]
  ...
  connect_bd_net -net pixelDataToVideoStre_0_o_pixel_x [get_bd_pins PPU_0/i_x_hdmi] [get_bd_pins pixelDataToVideoStre_0/o_pixel_x] [get_bd_pins send_to_HDMI_0/i_x_hdmi]
  connect_bd_net -net pixelDataToVideoStre_0_o_pixel_y [get_bd_pins PPU_0/i_y_hdmi] [get_bd_pins pixelDataToVideoStre_0/o_pixel_y] [get_bd_pins send_to_HDMI_0/i_y_hdmi]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins API_0/s00_axi_aresetn] [get_bd_pins PPU_0/reset] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins pixelDataToVideoStre_0/i_aresetn] [get_bd_pins pixelDataToVideoStre_0/s00_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins rgb2dvi_0/aRst_n] [get_bd_pins send_to_HDMI_0/rstn] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins v_proc_ss_0/aresetn_ctrl] [get_bd_pins v_tc_0/resetn]
  ...
  connect_bd_net -net send_to_HDMI_0_o_dataPixel [get_bd_pins pixelDataToVideoStre_0/i_dataPixel] [get_bd_pins send_to_HDMI_0/o_dataPixel]
  connect_bd_net -net send_to_HDMI_0_o_dataValid [get_bd_pins pixelDataToVideoStre_0/i_dataValid] [get_bd_pins send_to_HDMI_0/o_dataValid]
  ...
  assign_bd_address -offset 0x43C40000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs API_0/S00_AXI/S00_AXI_reg] -force
